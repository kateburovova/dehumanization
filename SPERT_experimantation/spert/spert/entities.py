...
class Entity:
    ...
    def __str__(self):
        return f"Entity(id={self.id}, type={self.type}, phrase={self.phrase}, tokens={self._tokens})"
    ...
    @property
    def span_start(self):
        # print("Tokens:", self._tokens)  # Debugging line
        # print("Tokens:", len(self._tokens))  # Debugging line
        return self._tokens[0].span_start
